...
public class TicTacToe {
            ...
            for (int c = 0; c < 3; c++){
                ...
                tile.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        if (gameOver) return; // If game is over, dont update tile anymore
                        JButton tile = (JButton) e.getSource();
                        // This is done so that you cannot change an existing X or O tile
    ...
    void checkWinner(){
        ...
        for (int r = 0; r < 3; r++ ){
            if (Objects.equals(board[r][0].getText(), "")){
                continue;
            }
        ...
        // Vertical
        for (int c = 0; c < 3; c++){
            if (Objects.equals(board[0][c].getText(), "")) {
                continue;
            }
